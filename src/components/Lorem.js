...
class Lorem extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
			...
			default 		: '<div><h1>I focus on creating high quality responsive websites and exceptional user experience</h1><p>WordPress & Front-end Developer | UX and UI design | Strategic Tech Solutions</p><p class="lorem__text--default-links"><a href="/portfolio">Work</a> • <a href="/about">About</a></p></div>',
			output 			: '',
			outputClass 	: '',
			paragraphs 		: 3,
			length 			: 3
