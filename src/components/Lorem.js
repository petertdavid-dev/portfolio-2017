...
class Lorem extends Component {
  ...
  constructor(props) {
	...
	componentDidMount() {
		this.refs.output.innerHTML = this.state.default;
	}
	...
	render() {
		...
		return (
		  <div className="Lorem">
		  	<form className="lorem__form content-section" onSubmit={this.generateLorem} >
				...
				<div className="lorem__para-length">
					<label><input name="para-length" type="radio" value="3" checked={this.state.length === 3} onChange={this.handleLengthChange} /> Short</label>
					<label><input name="para-length" type="radio" value="6" checked={this.state.length === 6} onChange={this.handleLengthChange} /> Medium</label>
					<label><input name="para-length" type="radio" value="9" checked={this.state.length === 9} onChange={this.handleLengthChange} /> Long</label>
				</div>

				<button type="submit">Generate TPS Report</button>
			</form>
			<button type="submit" onClick={this.defaultLorem} >Reset</button>
			<div className="lorem__text" ref="output"></div>
		  </div>
		);
	}
