...
class Lorem extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
			...
			default 		: '<div><h1>I focus on creating high quality responsive websites and exceptional user experience</h1><p>WordPress & Front-end Developer | UX and UI design | Strategic Tech Solutions</p></div>',
			output 			: '',
			outputClass 	: '',
			paragraphs 		: 3,
			length 			: 3
		...
		return (
		  <div className="Lorem">
		  	<form className="lorem__form" onSubmit={this.generateLorem} >
				...
				<button type="submit" onClick={this.defaultLorem} >Back to Intro</button>
			</form>
